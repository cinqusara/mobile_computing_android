...
public class MappaActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        Log.d(MTE_LOG, "onMapReady - mappa");
        mMap = googleMap;
    ...
    protected void onResume() {
        super.onResume();
        Log.d(MTE_LOG, "onResume ");
        Log.d(MTE_LOG, "richiesta di aggiornamento posizione --> " + requestingLocationUpdates);
    }

    @Override
    protected void onPause() {
        super.onPause();
        Log.d(MTE_LOG, "onPause");
    ...
    */
    ...
    public void startLocationUpdates() {
        Log.d(MTE_LOG, "mappa ---> " + mMap.toString());
        if(checkPermessiPosizione() ) {
    ...
    private boolean checkPermessiPosizione() {
        if (ContextCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            //I permessi non sono stati (ancora) concessi
            Log.d(MTE_LOG, "I permessi non sono stati (ancora) concessi");
